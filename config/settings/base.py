...
LOCAL_APPS = [
    ...
    "caustaza_backend_project.contacts.apps.ContactsConfig",
    "caustaza_backend_project.feedbacks.apps.FeedbacksConfig",
    "caustaza_backend_project.blogs.apps.BlogsConfig",
]
...
CSRF_TRUSTED_ORIGINS = ["https://8000-caustazagro-caustazabac-6o5xqescd1o.ws-eu103.gitpod.io/", "http://localhost"]
